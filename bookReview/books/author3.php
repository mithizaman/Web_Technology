...
<head>
    ...
    <title>Third Author - Book Details</title>
...
<body>
    ...
    <div class="book-container">
        <img src="../images/book3.jpg" alt="book" class="logo">
    ...
    <script>
        const authorKey = 'author3_reviews';
        ...
        let likes = parseInt(localStorage.getItem('author3_likes')) || 0;
        ...
        likeBtn.addEventListener('click', function () {
            likes++;
            likeCount.textContent = likes;
            localStorage.setItem('author3_likes', likes); // Save the like count to localStorage
        });
    </script>
</body>
</html>
