...
<head>
    ...
    <title>J.K. Rowling - Book Details</title>
...
<body>
    ...
    <div class="book-container">
        <img src="../images/hpBook.jpg" alt="book" class="logo">
        <h2>J.K. Rowling</h2>
    ...
    <script>
        const authorKey = 'author1_reviews';
        ...
        let likes = parseInt(localStorage.getItem('author1_likes')) || 0;
        ...
        likeBtn.addEventListener('click', function () {
            likes++;
            likeCount.textContent = likes;
            localStorage.setItem('author1_likes', likes); // Save the like count to localStorage
        });
    </script>
</body>
</html>
